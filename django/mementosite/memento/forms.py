...
class EditUserForm(forms.Form):
    ...
    password_r = forms.CharField(label='Repeat password', max_length=100, required=False)
...
class NewLayerForm(forms.Form):
    name = forms.CharField(label='Name', max_length=255)
    image_id = forms.IntegerField()
    lysettings = forms.CharField(label='Settings', max_length=1000, required=False)
